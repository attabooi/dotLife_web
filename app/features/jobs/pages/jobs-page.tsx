...
export default function QuestPage({ loaderData }: Route.ComponentProps) {
  const { quests, playerStats, todaySummary, userProfile } = loaderData || {};
                ...
                <div className="flex-1">
                  ...
                  <div className="space-y-2 mb-3">
                    <div className="flex justify-between text-sm">
                      ...
                      <span className="text-yellow-600 font-bold">{playerStats.current_xp}/{playerStats.xp_to_next_level}</span>
                    </div>
                    <div className="w-full h-2 bg-gray-200 rounded-full overflow-hidden shadow-inner">
                      <div 
                        ...
                        style={{ width: `${(playerStats.current_xp / playerStats.xp_to_next_level) * 100}%` }}
                      />
                    </div>
                  </div>
            ...
            <DialogContent>
              ...
              <DialogFooter>
                ...
                <form method="post" className="inline">
                  ...
                  <Button type="submit" className="bg-gradient-to-r from-blue-500 to-purple-600 text-white font-bold">
                    Confirm
                  </Button>
                </form>
              </DialogFooter>
                        ...
                        <div className="flex items-start justify-between">
                          <div className="flex-1">
                            {isEditing && !isConfirmed ? (
                              ...
                              <>
                                <CardTitle className={`text-lg ${isCompleted ? 'line-through text-gray-500' : 'text-gray-900'}`}>
                                  {quest.title}
                                </CardTitle>
                                <p className={`text-sm mt-2 ${isCompleted ? 'text-gray-500 line-through' : 'text-gray-600'}`}>
                                  {quest.description}
                                </p>
                              </>
                            )}
                          ...
                          <Badge
                            variant="outline"
                            className={`${difficultySettings[quest.difficulty as keyof typeof difficultySettings].color} text-white border-0 px-3 py-1 font-semibold`}
                          >
                            {quest.difficulty}
                          </Badge>
                        </div>
