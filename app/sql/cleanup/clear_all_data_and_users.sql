-- Clear all data AND delete all users from the database
-- This script will remove all user data, game data, and even the users themselves from auth
...
-- This will completely remove all user accounts from the authentication system
